...
class JourneyDataSpec extends JsonFormatSpec[JourneyData] {
  ...
  override val json: JsValue = Json.parse(
    s"""
       ...
       |  "thirdPartyOrganisations":{"managedByThirdParty":"yes","thirdParties":[{"id":"test","thirdPartyName":"test","thirdPartyFrn":"test","managingIsaReturns":true,"usingInvestorFunds":true,"investorFundsPercentage":1}],"connectedOrganisations":[]}
       |}
       |""".stripMargin
  )
